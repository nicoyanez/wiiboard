            ...
            while self.sigue:
                  ...
                  try:
                        ...
                        if str(self.wm.orient_threshold)[:3] !="0.0":
                              ...
                              if str(self.wm.orient_threshold)[:4]=="7.34":
                                    self.window.emit(SIGNAL("Boton"), "A y B")
...
class MyWindow(QtGui.QWidget):
      ...
      def QueBoton(self,nombre):
            self.label.setText("<font color='cyan'>se apretó " + nombre+"</font>")
            self.label1.setText("")
      def BotonSuelto(self,nombre):
            self.label1.setText("<font color='red'>se solto " + nombre+"</font>")
            self.label.setText("")
